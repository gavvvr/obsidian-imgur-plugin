...
describe('resizeTo', () => {
  it.each([
    {
      ...
      output: '[![](https://i.imgur.com/m3RpPCVs.png)](https://i.imgur.com/m3RpPCV.png)',
    },
    {
      input: '![](https://i.imgur.com/m3RpPCVm.png)',
      size: ImgurSize.BIG_SQUARE,
      output: '[![](https://i.imgur.com/m3RpPCVb.png)](https://i.imgur.com/m3RpPCV.png)',
    },
    {
      input: '![](https://i.imgur.com/m3RpPCVm.png)',
      size: ImgurSize.SMALL_THUMBNAIL,
      output: '[![](https://i.imgur.com/m3RpPCVt.png)](https://i.imgur.com/m3RpPCV.png)',
    },
    {
      input: '![](https://i.imgur.com/m3RpPCVm.png)',
      size: ImgurSize.MEDIUM_THUMBNAIL,
      output: '[![](https://i.imgur.com/m3RpPCVm.png)](https://i.imgur.com/m3RpPCV.png)',
    },
    {
      input: '![](https://i.imgur.com/m3RpPCVm.png)',
      size: ImgurSize.LARGE_THUMBNAIL,
      output: '[![](https://i.imgur.com/m3RpPCVl.png)](https://i.imgur.com/m3RpPCV.png)',
    },
    {
      input: '![](https://i.imgur.com/m3RpPCVm.png)',
      size: ImgurSize.HUGE_THUMBNAIL,
      output: '[![](https://i.imgur.com/m3RpPCVh.png)](https://i.imgur.com/m3RpPCV.png)',
    },
  ...
  it.each([
    {
      input: '[![](https://i.imgur.com/m3RpPCVs.png)](https://i.imgur.com/m3RpPCV.png)',
